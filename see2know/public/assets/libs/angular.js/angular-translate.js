 ...
 */
angular.module('translate', ['ng']).run([
  '$translate',
  function ($translate) {
...
angular.module('translate').provider('$translate', [
  '$STORAGE_KEY',
...
angular.module('translate').factory('$translateDefaultInterpolation', [
  '$interpolate',
...
angular.module('translate').constant('$STORAGE_KEY', 'NG_TRANSLATE_LANG_KEY');
angular.module('translate').directive('translate', [
  '$translate',
  '$q',
  '$interpolate',
  '$compile',
...
angular.module('translate').directive('translateCloak', [
  '$rootScope',
  '$translate',
...
angular.module('translate').filter('translate', [
  '$parse',
  '$translate',
